...
// TODO: Should we call this Convert()? Could we be implementing some interface by accident?
func (args *AttrActionSettings) Convert() []interface{} {
	//TODO: Is there an isEmpty?
	if len(args.Actions) == 0 {
		//TODO: Or return empty? The calling function has to check if it's empty anyway? Or not?
		return nil
	}
...
func (args *AttrActionKeyValue) Convert() map[string]interface{} {
	...
	// Optional attributes
	//TODO: Make a function to avoid all the repetition below/
	if args.Value != "" {
